...
public class LanguageHandler {
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("evolutioncore.tooltip.steam_centrifuge", "Centrifuging your Resin");
        ...
        provider.add("evolutioncore.tooltip.steam_alloy_kiln.h", "Steam-charged Parallelized Alloying Machine, Reinforced by Steel to sustain High Pressures");
        ...
        provider.add("evolutioncore.tooltip.steam_oven.h", "A Steam Oven! Reinforced by Steel to sustain High Pressures");
        provider.add("evolutioncore.tooltip.steam_separator.l", "Seperating.. with Steam?");
        provider.add("evolutioncore.tooltip.steam_separator.h", "Seperating.. with Steam? Reinforced by Steel to sustain High Pressures");
        provider.add("evolutioncore.tooltip.steam_purifier.l", "Washing with Steam!");
        provider.add("evolutioncore.tooltip.steam_purifier.h", "Washing with Steam! Reingforced by Steel to sustain High Pressures");
        ...
        provider.add("evolutioncore.tooltip.steam_greenhouse", "A Greenhouse for growing trees. It just needs water, but it can produce a wide variety of tree products.");
