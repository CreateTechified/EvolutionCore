...
public class PrimitiveBlastFurnace extends FueledPrimitiveMultiblockBase implements IMuiMachine {
    ...
    public PrimitiveBlastFurnace(BlockEntityCreationInfo info) {
        super(info, new RecipeLogic(), 2, 2, 0, 0, 0, 1, 4);
    ...
    public void buildMainUI(ParentWidget<?> mainWidget, PosGuiData guiData, PanelSyncManager syncManager,
        ...
        var importRow = createImportItemSlot(syncManager, theme);
                ...
                .key(key, i -> {
                    ...
                    return new ItemSlot()
                            ...
                            .background(theme.getItemSlotTheme().theme().getBackground(),
                                    (i == 0) ? GTGuiTextures.PRIMITIVE_INGOT_OVERLAY : GTGuiTextures.PRIMITIVE_DUST_OVERLAY);
                })
                .build();
    }
