...
public class ModToolTiers {
    ...
    public static final Tier MANYULLYN = TierSortingRegistry.registerTier(new ForgeTier(9, 1250, 6.5f, 3.5f, 30, ModTags.Blocks.NEEDS_MANYULLYN_TOOL, () -> Ingredient.of(ModTags.Items.INGOTS_MANYULLYN)), new ResourceLocation(Reference.MODID, "manyullyn"), List.of(getGTNeutroniumTier()), List.of());
