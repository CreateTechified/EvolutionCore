...
public class EvoLCEMachine extends WorkableElectricMultiblockMachine implements ITieredMachine {
    ...
    public EvoLCEMachine(BlockEntityCreationInfo info, int tier) {
        super(info);
        this.tier = tier;
     ...
     *
     * @param machine a {@link EvoLCEMachine}
     * @param recipe  recipe
     * @return A {@link ModifierFunction} for the given Combustion Engine
     */
    public static ModifierFunction recipeModifier(MetaMachine machine, GTRecipe recipe) {
        if (!(machine instanceof EvoLCEMachine engineMachine)) {
            return RecipeModifier.nullWrongType(EvoLCEMachine.class, machine);
        }
