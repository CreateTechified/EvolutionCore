...
public class EvoRecipeTypes {
    ...
    public static final GTRecipeType STEEL_GREENHOUSE = GTRecipeTypes.register("steam_greenhouse", "agriculture").setMaxIOSize(2, 5, 3, 0).UI(builder -> builder.setProgressBar(GTGuiTextures.PROGRESS_ARROW)).setSound(GTSoundEntries.BATH);
